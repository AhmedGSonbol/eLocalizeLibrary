...
import 'package:elocalize_library_task/features/books/widgets/book_widget_builder.dart';
    ...
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context, state)
      {
        ...
        return Column(
          ...
          children:
          [
            Text('Books',style: TextStyles.font26DarkBlueBold),
            ...
            ListView.separated(
              ...
              {
                return BookWidgetBuilder(book_model: cubit.booksModel[index],);
